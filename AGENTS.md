...
simplify work (read/write) with data in Apache Cassandra.  You follow the architecture and
...
working with Apache Cassandra in batch and/or streaming manner.
...
Documentation about Apache Cassandra is available at:

- [Apache Cassandra docs](https://cassandra.apache.org/doc/latest/)
- [Python driver docs](https://docs.datastax.com/en/developer/python-driver/3.29/index.html)
- [Documentation for original Spark connector](https://github.com/apache/cassandra-spark-connector?tab=readme-ov-file#quick-links)
